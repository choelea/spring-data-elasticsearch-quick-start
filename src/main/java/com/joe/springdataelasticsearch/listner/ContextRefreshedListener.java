...
//		elasticsearchTemplate.createIndex(StoreDoc.class, setting); 
	...
	private void createStoreDocs() {
		elasticsearchTemplate.index(new StoreDocBuilder(0l).name("XiaoMi Authorized Shop").mainProducts("Smart Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(1l).name("Oppo Authorized Owned by Joe in Wuhan Shop").mainProducts("Smart Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(2l).name("Meizu Authorized Shop Double Authorized").mainProducts("Smart Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(3l).name("Sung Authorized Shop").mainProducts("Smart Phone , Stupid Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(4l).name("Vivo Authorized Shop").mainProducts("Smart Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(5l).name("Lenovo Authorized  Shop").mainProducts("Stupid Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(6l).name("Sony Authorized VIP Shop").mainProducts("Stupid Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(7l).name("Apple Store").mainProducts("Ipad, Mac Pro").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(8l).name("Samsung Authorized Shop").mainProducts("Smart Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(9l).name("Smart Shop").mainProducts("Smart Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(10l).name("Mark's Mobile Shop").mainProducts("Smart Phone, Stupid Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(11l).name("Charlice Mobile Shop").mainProducts("Apple Phone, Old Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(12l).name("Charlice Mobile Shop").mainProducts("Apple Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(13l).name("Charlice Mobile Shop").mainProducts("Apple Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(14l).name("Oppo Authorized Shop Owned by Joe in Wuhan").mainProducts("Apple Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(15l).name("Charlice Fruit Shop").mainProducts("Pear, Watermelon").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(16l).name("Jane's Mobile Shop").mainProducts("Smart-Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(17l).name("Charlise Shop").mainProducts("Smart Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(18l).name("Authorized Owned by Joe Phone Meizu Shop").mainProducts("Smart Phone").rating(4.9f).fullText().buildIndex());		
		elasticsearchTemplate.index(new StoreDocBuilder(19l).name("Meizu Authorized Phone Shop Located in Wuhan Optic Valley Software Park").mainProducts("Smart Phone").rating(4.9f).fullText().buildIndex());
		elasticsearchTemplate.index(new StoreDocBuilder(20l).name("Authorized Phone Meizu Shop").mainProducts("Smart Phone").rating(4.9f).fullText().buildIndex());
		for(int i=21; i<30; i++) {
			elasticsearchTemplate.index(new StoreDocBuilder(Long.valueOf(i).longValue()).name("Charlise Shop").mainProducts("Apple Phone").rating(4.9f).fullText().buildIndex());
		}
	}
